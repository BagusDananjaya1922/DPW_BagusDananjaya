<div class="sidebar">
    ...
    <ul class="sidebar-menu">
        ...
        <li>
            <a href="<?php echo ($page == 'tampil.php' && strpos($_SERVER['REQUEST_URI'], 'matakuliah') !== false) ? '#' : ( ($page == 'tampil_dosen.php') ? 'matakuliah/tampil.php' : '../matakuliah/tampil.php' ); ?>" class="<?php echo (strpos($_SERVER['REQUEST_URI'], 'matakuliah') !== false) ? 'active' : ''; ?>">
